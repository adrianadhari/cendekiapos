            ...
            <div class="row">
                ...
                <div class="col-md-9" data-aos="fade-up">
                    ...
                    <div class="d-md-flex post-entry-2 half">
                        <a href="{{ url('/single-post') }}" class="me-4 thumbnail">
                        ...
                        <div>
                            ...
                            <h3><a href="{{ url('/single-post') }}">What is the son of Football Coach John Gruden, Deuce
                ...
                <div class="col-md-3">
                    ...
                    <div class="aside-block">
                        ...
                        <ul class="aside-tags list-unstyled">
                            <li><a href="{{ url('/category') }}">Business</a></li>
                            <li><a href="{{ url('/category') }}">Culture</a></li>
                            <li><a href="{{ url('/category') }}">Sport</a></li>
                            <li><a href="{{ url('/category') }}">Food</a></li>
                            <li><a href="{{ url('/category') }}">Politics</a></li>
                            <li><a href="{{ url('/category') }}">Celebrity</a></li>
                            <li><a href="{{ url('/category') }}">Startups</a></li>
